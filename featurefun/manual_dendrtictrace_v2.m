...
if ~isempty(pt_all)
    ...
    function showDendROI(handles)
        ...
        uicontrol(hplot,'style','Text',...
            'String', 'Set Linewidth (pixel): 2 x ',...
            'Fontsize', 12,...
            'Units', 'normalized', 'position',[0.3 0.03 0.2 0.04])
        setlinewidth = uicontrol(hplot,'style','edit',...
            'String', num2str(ceil(linewidthtmp/2)),...
            'Fontsize', 12,...
            'Units', 'normalized', 'position',[0.52 0.035 0.1 0.04],...
    ...
    function refreshDendROI(hObject, event)
        linewidthtmp = 2*ceil(str2double(get(hObject, 'String')));
